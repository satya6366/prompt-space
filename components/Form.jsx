  ...
  return (
    <section className='w-full max-w-full flex-start flex-col'>
      ...
      <p className='desc text-left max-w-d'>
        {type} ans share amazing prompts with the world, and let your imagination
      ...
      className="mt-10 w-full max-w-2xl flex flex-col gap-7 glassmorphism">
        ...
        <label>
          ...
          <span className='font-normal'>(#product, #backend, #frontend, #cloud)</span>
          </span>
          <textarea value={post.tag}
